...
import { useGetOpServiceDetails } from "../../../services/operator/query/transactions";
...
const ViewServiceBooking = () => {
  ...
  const { mutate, data, isLoading } = useGetOpServiceDetails();
        ...
        <Flex justifyContent="center" align="center" w="full" flexDir="column">
          <Skeleton isLoaded={!isLoading} borderRadius="12px">
            ...
            <Flex
              ...
              flexDir="column"
            >
              <Layout label="Booking ID" data={data?.bookingId} />
