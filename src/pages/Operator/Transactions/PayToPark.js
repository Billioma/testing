...
import { useGetOpPtp } from "../../../services/operator/query/transactions";
import PtpTableLayer from "../../../components/data/Operator/Transactions/PtpTableLayer";
...
const PayToPark = () => {
  ...
  const { data, isLoading, refetch } = useGetOpPtp(
    {
