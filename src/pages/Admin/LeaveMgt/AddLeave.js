...
const AddLeave = () => {
  ...
  const { mutate, isLoading } = useAdminCreateLeave({
    onSuccess: () => {
      successToast("Leave created successfully!");
      navigate(PRIVATE_PATHS.ADMIN_LEAVE_MGT);
    },
    onError: (error) => {
      errorToast(
        ...
        <Flex justifyContent="center" align="center" w="full" flexDir="column">
          ...
          >
            ...
            >
              ...
              >
                <Text fontWeight={500}>Leave Balance</Text>
                <Text fontWeight={700}>
            ...
            <Formik
              ...
              initialValues={initAdminLeaveValues}
              validationSchema={validateAdminLeaveSchema}
            >
              {({
                values,
                errors,
                ...
                >
                  ...
                  <Flex gap="24px" mt="24px">
                    <Button
                      ...
                      w="45%"
                      onClick={() => navigate(PRIVATE_PATHS.ADMIN_LEAVE_MGT)}
                    >
                      Cancel
                    </Button>
                    <Button
                      variant="adminPrimary"
                      isDisabled={values?.endDate < values?.startDate}
                      w="55%"
                      isLoading={isLoading}
                      type="submit"
                    >
