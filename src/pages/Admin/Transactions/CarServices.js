...
import { useGetAdminCarServicesList } from "../../../services/admin/query/transactions";
import { carServiceOptions } from "../../../components/common/constants";
...
export default function () {
  ...
  const { mutate, data, isLoading } = useGetAdminCarServicesList();
  ...
  return (
    <Box border="1px solid #d4d6d8" borderRadius="8px" p="16px 23px 24px">
      <Filter
        ...
        filtArray={filtArray}
        fieldToCompare={carServiceOptions}
        handleSearch={() =>
