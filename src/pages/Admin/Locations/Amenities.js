...
import AmenitiesTableLayer from "../../../components/data/Admin/Locations/AmenitiesTableLayer";
import { Box, Button, Flex, Image, Text } from "@chakra-ui/react";
import { useNavigate } from "react-router-dom";
import { PRIVATE_PATHS } from "../../../routes/constants";
import Filter from "../../../components/common/Filter";
import { amenitiesOptions } from "../../../components/common/constants";
import { useGetAdminAmenities } from "../../../services/admin/query/locations";
...
export default function () {
  ...
  const { mutate, data, isLoading } = useGetAdminAmenities();
    ...
    <Box border="1px solid #d4d6d8" borderRadius="8px" p="16px 23px 24px">
      <Filter
        ...
        main={
          <>
            <Button
              onClick={() => navigate(PRIVATE_PATHS.ADMIN_ADD_AMENITY)}
              display="flex"
              bg="#000"
              gap="8px"
            >
