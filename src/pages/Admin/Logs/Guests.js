...
import GuestTable from "../../../components/data/Admin/Logs/GuestTable";
import { Box, Flex, Image, Text } from "@chakra-ui/react";
import { useGetAdminGuestLogs, useGetValetedVehicles } from "../../../services/admin/query/logs";
import { guestVehiclesOptions } from "../../../components/common/constants";
...
export default function () {
  ...
  const { data, isLoading, refetch } = useGetAdminGuestLogs(
    {
  ...
  return (
    <Box border="1px solid #d4d6d8" borderRadius="8px" p="16px 23px 24px">
      <Filter
        ...
        filtArray={filtArray}
        fieldToCompare={guestVehiclesOptions}
        gap
        title={
