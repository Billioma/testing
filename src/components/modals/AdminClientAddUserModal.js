  ...
  return (
    <ModalLayout isOpen={isOpen} onClose={close}>
      ...
      <Box borderRadius="8px" p="16px" border="1px solid #e4e6e8">
        ...
        <Flex h="35vh" overflowY="scroll" flexDir="column" gap="24px" mt="16px">
          {isLoading ? (
            ...
            entityCustomers
              ?.filter(
                (user) =>
                  !userToMap?.some((clientUser) => clientUser.id === user.id)
              )
              ?.map((user, i) => (
                <Flex
                  align="center"
                ...
                >
                  ...
                  <Flex
                    ...
                    onClick={() =>
                      isAttaching || isDetaching ? "" : handleUserClick(user)
                    }
                    bg={
