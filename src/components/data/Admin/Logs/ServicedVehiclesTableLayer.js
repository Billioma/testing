...
import { useDeleteServicedVehicle } from "../../../../services/admin/query/logs";
        ...
        {data?.data?.length ? (
                  ...
                  <Menu>
                    ...
                    <MenuList>
                      <MenuItem
                        ...
                        onClick={() =>
                          navigate(
                            "/admin/logs/serviced-vehicles/details/" + item.id,
                            {
          ...
          <Tr>
            <Td colSpan={7} rowSpan={2}>
              <NoData
                title="No Serviced Vehicle"
                desc="You have not added a serviced vehicle"
              />
            </Td>
          </Tr>
        )}
