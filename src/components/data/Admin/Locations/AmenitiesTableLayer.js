...
const TableLayer = ({
  ...
  const openOption = (i, amenity) => {
    i === 0
      ? navigate(`/admin/locations/amenities/details/${amenity?.id}`)
      : i === 1
      ? (navigate(`/admin/locations/amenities/details/${amenity?.id}`),
        sessionStorage.setItem("edit", "edit"))
      : i === 2 && setSelectedRow({ isOpen: true, id: amenity?.id });
  };
