...
const TableLayer = ({
  ...
  const openOption = (i, faq) => {
    i === 0
      ? navigate(`/admin/configurations/faqs/details/${faq?.id}`)
      : i === 1
      ? (navigate(`/admin/configurations/faqs/details/${faq?.id}`),
        sessionStorage.setItem("edit", "edit"))
      : i === 2 && setSelectedRow({ isOpen: true, id: faq.id });
  };
          ...
          >
            {data?.data?.map((faq, i) => (
              ...
              >
                ...
                <Td textAlign="center">
                  {formatDateNewTime(faq?.createdAt, null, true)}
                </Td>
                <Td>
