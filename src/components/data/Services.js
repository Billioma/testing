...
const Services = () => {
  return (
    <div className="full_width">
      <div className="flex items-center justify-center flex-col bg-[#131618] relative py-[40px] lg:py-[160px] px-[20px] lg:px-[120px] mt-[100px] lg:mt-[144px]">
        <div className="text-center font-[Cooper] text-white text-[40px] lg:text-[64px] font-[900] mb-[40px] lg:mb-[90px]">
          Our Services
        </div>
