...
export const PRIVATE_PATHS = {
  ...
  ADMIN_AUDIT_LOCATIONS_DETAILS: "/admin/audit/locations/:id/:locationId/:managerId",
  ...
  METRICS_LOCATION: "/analytics/metrics/locations",
  METRICS_ATTENDANTS: "/analytics/metrics/attendants",
  METRICS_POINTS: "/analytics/metrics/points",
  METRICS_INCIDENTS: "/analytics/metrics/incidents-claims",
  METRICS_BUSINESS: "/analytics/metrics/businesses",
  METRICS_TRANSACTIONS: "/analytics/metrics/transactions&invoices",
  METRICS_LOCATION_DETAILS: "/analytics/metrics/locations/:id",
  ...
  ADMIN_EDIT_INCIDENT: "/admin/claims/:id/update",
};
