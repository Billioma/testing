...
export const PRIVATE_PATHS = {
  ...
  CUST_SERVICES_RESERVE_PARK_DETAILS: "/customer/services/reserve-parking/:id",
  CUST_HISTORY_RESERVE_PARK_DETAILS: "/customer/history/reserve-parking/:id",
  CUST_SERVICES_EVENT_PARK: "/customer/services/event-parking",
  CUST_SERVICES_EVENT_PARK_DETAILS: "/customer/services/event-parking/:id",
  CUST_HISTORY_EVENT_PARK_DETAILS: "/customer/history/event-parking/:id",
